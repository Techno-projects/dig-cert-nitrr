...
from .views import user_register, user_login, register_event, faculty_register, faculty_login, approveL0, get_rows, get_event_details, get_all_org, get_faculties
